        ...
        <main className="grid min-h-screen max-w-screen p-4 justify-center place-items-start">
            ...
            <form onSubmit={e => onSubmit(e)} className="shadow-lg border-2 overflow-hidden border-blue-500 rounded-3xl mx-auto max-w-xl sm:w-[30rem] flex flex-col">
                <header className="px-8 py-4 bg-blue-400 text-white">
                    <legend className="text-xl md:text-2xl font-bold">Registrar Cartão de {customer?.fullName}</legend>
                </header>
                <main className="px-8 py-4 flex flex-col gap-4 bg-white">
                    ...
                    <div>
                        ...
                        <input onChange={onChangeCard} type="text" name="number" value={creditCard.number} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="123456789101" required />
                    </div>
                    <div>
                        <label htmlFor="cvv" className="block text-sm font-medium text-gray-900 ">CVV</label>
                        <input onChange={onChangeCard} type="text" name="cvv" value={creditCard.cvv} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="1234" required />
                    </div>
                    <div>
